...
az vmss create --resource-group $rgname --name $vmssname --image Canonical:UbuntuServer:16.04-LTS:latest --admin-username azureuser --ssh-key-value $pubkeypath --upgrade-policy-mode Automatic --instance-count 5
